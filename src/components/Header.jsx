      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative w-64 hidden md:block">
          ...
          <input
            ...
            className="w-full bg-slate-950/80 border border-slate-800 rounded-xl pl-9 pr-4 py-2 text-xs text-slate-200 focus:outline-none focus:border-cyan-400 font-medium transition-all"
          />
        </div>
