    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-extrabold text-custom-taupe tracking-tight flex items-center gap-2">
          <Droplets className="w-7 h-7 text-custom-terra" /> Waterlogging & Hydro-Intelligence
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white shadow-sm border border-custom-sage/30 p-5 rounded-2xl border border-custom-sage/30">
          <span className="text-xs text-custom-sage font-medium font-semibold uppercase tracking-wider">Active Hotspots</span>
          <h3 className="text-3xl font-extrabold text-custom-terra mt-2">34</h3>
          <p className="text-[11px] text-custom-sage font-medium mt-1">Monitored across 6 zones</p>
        </div>

        <div className="bg-white shadow-sm border border-custom-sage/30 p-5 rounded-2xl border border-custom-sage/30">
          <span className="text-xs text-custom-sage font-medium font-semibold uppercase tracking-wider">High Risk Slopes</span>
          <h3 className="text-3xl font-extrabold text-orange-400 mt-2">18</h3>
          <p className="text-[11px] text-custom-sage font-medium mt-1">Subgrade degradation alert</p>
        </div>

        <div className="bg-white shadow-sm border border-custom-sage/30 p-5 rounded-2xl border border-custom-sage/30">
          <span className="text-xs text-custom-sage font-medium font-semibold uppercase tracking-wider">Drainage Blocked</span>
          <h3 className="text-3xl font-extrabold text-amber-400 mt-2">11</h3>
          <p className="text-[11px] text-custom-sage font-medium mt-1">Culvert obstruction flagged</p>
        </div>

        <div className="bg-white shadow-sm border border-custom-sage/30 p-5 rounded-2xl border border-custom-sage/30">
          <span className="text-xs text-custom-sage font-medium font-semibold uppercase tracking-wider">Critical Submerged</span>
          <h3 className="text-3xl font-extrabold text-rose-400 mt-2">5</h3>
          <p className="text-[11px] text-custom-sage font-medium mt-1">Immediate pumping required</p>
        </div>
      </div>
      ...
      <div className="bg-white shadow-sm border border-custom-sage/30 p-6 rounded-2xl border border-custom-sage/30 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-custom-sage font-medium">Monthly precipitation (mm) correlated with road pothole expansion</p>
          </div>
        </div>
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-cyan-950/60 to-blue-950/60 border border-cyan-500/30 flex items-start gap-4 shadow-xl">
        <div className="w-10 h-10 rounded-xl bg-cyan-500/20 text-custom-terra flex items-center justify-center shrink-0">
          <Lightbulb className="w-6 h-6" />
        </div>
        <div className="space-y-1 text-xs">
          <h4 className="text-sm font-extrabold text-custom-terra uppercase tracking-wider">AI Hydro-Infrastructure Insight</h4>
          <p className="text-custom-taupe leading-relaxed font-medium">
